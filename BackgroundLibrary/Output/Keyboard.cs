...
namespace BackgroundLibrary.Output
{
    /// <summary>
    /// This is a copied class from stackoverflow. :) 
    /// <para></para>Everything after this text is not from the Author of BackgroundLibrary. Except of <seealso cref="Keyboard.exec(DirectXKeyStrokes[])"/>
    /// 
    /// 
